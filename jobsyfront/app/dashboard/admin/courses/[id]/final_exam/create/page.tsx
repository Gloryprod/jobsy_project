...
export default function CreateFinalExamQuestion({ params }: { params: Promise<{ id: string }> }){
    const {id } = use(params);
    const pageLink = `/dashboard/admin/courses/${id}/final_exam/create`;

    return(
        <div className="min-h-screen relative p-4 md:p-8 bg-gray-100">
            <div className="mb-6">
                <PageInfo pageName="Ajouter une question à l'examen final" pageLink={pageLink} />
            </div>
