...
export default function Navigation() {
    const { handleLogout } = useLogout();
     ...
     const navItem = [
        { id: "home", name: "Tableau de bord", icon: Home, href: "/dashboard/admin" },
        { id: "applicants", name: "Candidats", icon: Briefcase, href: "/dashboard/admin/listCandidateProfile" },
        { id: "enterprises", name: "Entreprises", icon: FileClock, href: "/dashboard/admin/entreprises/list" },
    ]
